...
function UserDashboard() {
  ...
  const fetchAcceptMessages = useCallback(async () => {
    ...
    try {
      ...
      toast.success('Message settings fetched successfully'); // ✅ success toast
    } catch (error) {
  ...
  const fetchMessages = useCallback(
    async (refresh: boolean = false) => {
      ...
      try {
        ...
        if (refresh) {
          toast.success('Showing latest messages'); // ✅ success toast
        }
      } catch (error) {
        if (axios.isAxiosError(error)) {
          toast.error(
  ...
  const handleSwitchChange = async () => {
    try {
      ...
      toast.success(response.data.message); // Cleaner and simpler
    } catch (error) {
